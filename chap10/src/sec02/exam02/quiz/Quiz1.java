...
//	마지막까지 잘 도착했어요!!
	...
	public static void main(String[] args) {
		...
		System.out.println("첫번째 숫자: " + value1);
		System.out.println("두번째 숫자: " + value2);
		
		try {
			int resultAdd = calc.add(value1, value2);
			System.out.println("합: " + resultAdd);
			int resultMultiple = calc.multiple(value1, value2);
			System.out.println("곱: " + resultMultiple);
			// 예외 발생 가능한 코드(try 범위는 가능한 최소화 하는 게 의도가 명확함)
			int resultDivide = calc.divide(value1, value2);
