...
//	전체 주문 취소: []
	...
	public static void main(String[] args) {
		...
		Set<Food> orderSet = new HashSet<Food>();
		orderSet.add(new Food("샐러드", 14000));
		orderSet.add(new Food("치킨", 23000));
		orderSet.add(new Food("치킨", 50000));
		
		System.out.println("전체 리스트");
		System.out.println(orderSet);
		
		System.out.println("50000원 치킨 삭제");
		orderSet.remove(new Food("치킨", 50000));
		System.out.println(orderSet);
